...
import session_beans.UnidadFacade;
...
public class UnidadController implements Serializable {
    ...
    @EJB
    private session_beans.UnidadFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle").getString("UnidadCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle").getString("UnidadUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle").getString("UnidadDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public Unidad getUnidad(java.lang.Integer id) {
    ...
    public static class UnidadControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Unidad) {
                ...
                return getStringKey(o.getCodUnidad());
            } else {
